...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative border-t border-white/10 bg-slate-950 text-slate-300">
      <div className="mx-auto flex min-h-14 max-w-6xl flex-col items-center justify-center gap-1 px-4 py-2 text-center text-[11px] sm:flex-row sm:items-center sm:justify-between sm:text-left">
        <div>
